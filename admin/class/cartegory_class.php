...
public function update_cartegory($cartegory_ten,$cartegory_id) {
    $query = "UPDATE tbl_cartegory SET cartegory_name = '$cartegory_ten' WHERE cartegory_id = '$cartegory_id'";
